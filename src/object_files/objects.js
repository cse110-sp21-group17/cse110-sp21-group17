...
class Entry {
    constructor(text = "", entryDate = new EntryDate()) {
        this.text_m = text;
...
class Task extends Entry {
    constructor(text = "", description = "", isCompleted = false, entryDate = new EntryDate()) {
        super(text, entryDate);
        this.description_m = description;
        this.isCompleted_m = isCompleted;
    }
}
...
class Event extends Entry {
    constructor(text = "", isCompleted = false, entryDate = new EntryDate()) {
        super(text, entryDate);
        this.isCompleted_m = isCompleted;
    }
}
